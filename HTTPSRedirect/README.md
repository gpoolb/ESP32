...
***IMPORTANTE***
Para que pueda funcionar en ESP32 requiere descomentar la 

Ln. 89 stop(); // may not be required

y agregar el siguente comando:

Ln. 182 _redirUrl.trim(); // Quita los caracteres que no se imprimen
